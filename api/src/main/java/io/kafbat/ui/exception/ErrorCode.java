...
public enum ErrorCode {
  ...
  PARTITION_REASSIGNMENT_CONFLICT(4022, HttpStatus.CONFLICT),
  PARTITION_REASSIGNMENT_EXECUTION_DISABLED(4023, HttpStatus.FORBIDDEN),
  OAUTH_TOKEN_FETCH_ERROR(5002, HttpStatus.INTERNAL_SERVER_ERROR),
  ;
